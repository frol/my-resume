...
\cventry{June\,2012 -- March\,2018}{Software Engineer}{Data Mining and Predictive Analytics Software company}{}{}{%
    ...
    The team I led was in charge of solving all the technical problems (development and operations). \vspace{0.4em}
    \begin{itemize}
        \item Backend: \textsc{\color{darkgray}
                ...
                \mbox{Hadoop HDFS},
                \mbox{PostgreSQL}, \mbox{RabbitMQ}, \mbox{Redis}, \mbox{SeaweedFS}
            } \\ \vspace{-0.6em}
        \item Frontend: \textsc{\color{darkgray}
                \mbox{JavaScript (ES6)}, \mbox{ReactJS}, \mbox{Redux}
            } \\ \vspace{-0.6em}
        \item Operations: \textsc{\color{darkgray}
                \mbox{AWS}, \mbox{Linux}, \mbox{Docker}, \mbox{Hadoop}, \mbox{FreeIPA},
                \mbox{Rancher}, \mbox{GitLab}, \mbox{GitLab CI},
                \mbox{NGINX}, \mbox{Jenkins}, \mbox{PyInvoke},
                \mbox{Anaconda}
            }
    \end{itemize}
}
...
\cventry{September\,2009 -- today}{Contributor}{open-source software}{}{}{%
    ...
    At that time, I had already been using Linux for over two years, but most of my projects were written from scratch, meaning that I didn't use any thirdparty libraries. \\ \vspace{-0.6em}\\
    It was September 29, 2009, when the first project I published to the open-source was born.
    Since then I have open-sourced over 30 projects and contributed to over 100, including Linux kernel, Android for x86, Docker, and Django. \\ \vspace{-0.6em}\\
    I am an active maintainer of some packages on \href{https://hub.docker.com/u/frolvlad}{\underline{Docker Hub}}
    and \href{https://github.com/frol?tab=repositories&q=feedstock}{\underline{conda-forge} (Anaconda Python)}. \\ \vspace{-0.6em}\\
    My recent contributions are around Rust packages (cgroups integration, flatbuffers helpers, API ergonomics). \\ \vspace{-0.6em}\\
    \textsc{\color{darkgray} -- Git, Linux, Docker, Heroku, Rust, Python, JS, Travis CI, CircleCI}
}
...
\cventry{March\,2015 -- today}{Education Evangelist}{local science community}{}{}{%
    ...
    teach programming and to conduct programming contests. I have
    designed, developed, and deployed
    \href{https://gitlab.com/dots.org.ua/ddots}{\underline{the backend}} in
    Rust and Python that does automatic compilation and execution of student
    solutions in over 15 different programming languages. \\ \vspace{-0.6em}\\
    \textsc{\color{darkgray} -- Linux, Docker, NGINX, Rust, Python, C, Bash, JS, PHP, C++, Pascal}
}
...
\cventry{April\,2011 -- May\,2012}{Software Engineer}{Website building company}{}{}{%
    ...
    (\url{mafia.ua}) and ``Yakitoria'' (\url{yaki.kh.ua}) \\ \vspace{-0.6em}\\
...
\vspace{0.35em}
\subsection{Classes}
\cventry{2005 -- 2009}{Student}{}{}{}{%
    I was taught algorithms and data structures in Pascal, and so I competed in
    a number of individual (IOI and alike) and team competitions. Later, I
    ...
    \textsc{\color{darkgray} -- Pascal, Delphi, C++, Qt, Linux}
}

\section{\textsc{Professional Skills} \small{\textit{(my preferences are marked in bold)}}}
